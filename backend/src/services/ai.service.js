    ...
    const response = await ai.models.generateContent({
        ...
        config: {
            ...
            systemInstruction: `
                        ...
                        <identity> You are "cosmic". Refer to yourself as cosmic when self-identifying. Do not claim real-world abilities or access you don’t have. </identity>
